...
export function SnowballMigrationDiagram() {
  ...
  const getStageText = () => {
    if (method === 'snowball') {
      switch (stage) {
        case 1:
          return '📦 Snowball Edge 디바이스 수령';
        case 2:
          return '💾 로컬에서 데이터 복사 중...';
        case 3:
          return '🚚 디바이스 AWS로 반송';
        case 4:
          return '✅ S3로 데이터 임포트 완료!';
        default:
          return '시작 대기...';
      }
    } else if (method === 'cli') {
      ...
      >
          ...
          >
            <div className="w-full h-full flex items-center justify-center">
              ...
              >
                ...
                {method === 'cli' && (
                  <span className="text-[9px] text-red-500 font-bold">대역폭 사용 중</span>
                )}
              </div>
            </div>
          </foreignObject>
        ...
        {method === 'snowball' && (
          ...
          >
            <div className="w-full h-full flex items-center justify-center">
              <div
                className={`flex flex-col items-center p-3 rounded-xl border-[3px] transition-all duration-300 bg-white dark:bg-slate-900 shadow-xl
              ...
              >
                ...
                <span className="text-xs font-bold text-cyan-700 dark:text-cyan-300 mt-1">
                  Snowball Edge
                </span>
        ...
        >
          <div className="w-full h-full flex items-center justify-center">
            ...
            >
              <Cloud
                size={28}
                className={`${method === 'snowball' && stage >= 4 ? 'text-green-500' : 'text-orange-500'}`}
              />
        ...
        {method && (
          ...
          >
            <div className="w-full h-full flex items-center justify-center">
              <div
                className={`flex items-center gap-2 px-4 py-2 rounded-xl shadow-lg border-2 text-sm font-bold
                ${
                  method === 'snowball' && stage >= 4
        ...
        <div className="flex-1 p-6 md:p-8 flex flex-col bg-white dark:bg-slate-950">
          ...
          <div className="mt-6 pt-6 border-t border-slate-100 dark:border-slate-800">
            <div className="bg-slate-50 dark:bg-slate-900 p-4 rounded-xl text-xs text-slate-600 dark:text-slate-400 leading-relaxed mb-3">
              ...
              일반적으로 <strong>10TB 이상</strong>의 데이터를 이전할 때, 또는 네트워크 대역폭이
              제한적일 때 Snowball이 더 효율적입니다.
            </div>
