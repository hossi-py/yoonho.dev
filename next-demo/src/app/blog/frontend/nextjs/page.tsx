...
export const metadata: Metadata = {
  ...
  description: 'Next.js 학습 글 모음',
};

export default async function FrontendNextjsPage() {
    ...
    <div className="min-h-screen bg-slate-50 dark:bg-slate-950">
      <main className="mx-auto max-w-5xl px-4 py-10 md:px-6 md:py-12">
        ...
        <section className="relative overflow-hidden rounded-3xl border border-slate-200/90 bg-white px-4 py-6 shadow-sm md:px-7 md:py-8 dark:border-slate-800 dark:bg-slate-900">
          <div className="pointer-events-none absolute inset-0 bg-[radial-gradient(circle_at_top_left,_rgba(100,116,139,0.16),_transparent_45%)] dark:bg-[radial-gradient(circle_at_top_left,_rgba(100,116,139,0.12),_transparent_45%)]" />
          <div className="relative mb-7">
            ...
            <p className="mt-2 text-sm leading-relaxed text-slate-600 md:text-[15px] dark:text-slate-300">
              기본 필터는 Next.js로 맞춰두었고, 같은 영역에서 React/Vue로 바로 전환할 수 있습니다.
            </p>
          </div>
