  ...
  meta: {
    ...
    title: (
      <>
        ...
        <span className="text-indigo-600 dark:text-indigo-400">S3 버킷 접근 허용하기</span>
      </>
    ),
    description:
  ...
  services: {
    ...
    insight: (
      <p className="text-xs md:text-sm text-blue-700 dark:text-blue-300">
        ✨ <strong>핵심 인사이트:</strong> &quot;여러 계정&quot; + &quot;우리 조직 식구들만&quot; +
        &quot;최소 오버헤드&quot; 키워드가 뭉치면? <br />
    ...
    <>
      <div className="space-y-6">
        ...
        <p className="text-sm text-slate-600 dark:text-slate-300">
          실제 S3 버킷 정책에 적용되는 모습입니다. 계정 ID 대신 조직 ID(`o-12345678`)가 사용된 것에
          주목하세요.
        </p>
