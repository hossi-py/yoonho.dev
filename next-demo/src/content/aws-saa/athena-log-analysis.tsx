  ...
  meta: {
    ...
    title: (
      <>
        ...
        <span className="text-indigo-600 dark:text-indigo-400">Amazon Athena</span>
      </>
    ),
    description:
  ...
  services: {
    ...
    insight: (
      <p className="text-xs md:text-sm text-blue-700 dark:text-blue-300">
        ✨ <strong>핵심 인사이트:</strong> &quot;S3에 있는 데이터&quot;를 &quot;SQL&quot;로 분석하고
        싶고 &quot;인프라 관리&quot;가 싫다면? <br />
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          <Card className="border-l-4 border-l-green-500">
            <CardContent className="p-4">
              <h4 className="font-bold text-green-700 dark:text-green-400 mb-2">Amazon Athena</h4>
